							...
							<table class="table" style="line-height:2.5;" id="TableMain">
								<tr>
									<td colspan="2">Class Name &nbsp;&nbsp;&nbsp;&nbsp; 
									   <select class="form2" name="class" id="class" onChange="showSubject(this.value)" onclick="showSubject(this.value)">
								...
								<tr>
									<td colspan="2">Subject &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
										<select class="form2" name="subject" id="subject" onChange="showtopic(this.value)" onclick="showtopic(this.value)">
								...
								<tr>
								   <td colspan="2">Topic &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<select class="form2" name="topic" id="topic">
